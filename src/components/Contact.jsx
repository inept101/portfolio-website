export default function Contact() {
  return (
    <section id="contact" className="max-w-4xl mx-auto px-6 py-16 border-t border-zinc-200 dark:border-zinc-800">
      <span className="font-mono text-xs text-zinc-400 dark:text-zinc-600 tracking-widest uppercase">
        # contact
      </span>
      <h2 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100 mt-2 mb-3">
        Get in Touch
      </h2>
      <p className="text-zinc-500 dark:text-zinc-400 mb-8 max-w-lg leading-relaxed">
        Open to backend, cloud, and full-stack roles. Drop me a line and I&apos;ll
        get back to you within a day.
      </p>
      <div className="flex flex-wrap gap-4">
        {[
          {
            label: 'akashchandra1369@gmail.com',
            href: 'mailto:akashchandra1369@gmail.com',
            icon: <EmailIcon />,
          },
          {
